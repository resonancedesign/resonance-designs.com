<?php
    ...
    $sqlTalks = mysql_query("SELECT * FROM portfolio WHERE category='printdesign' ORDER BY placement ASC");
    ...
    while($row = mysql_fetch_array($sqlTalks)){
        ...
        $portfolioDisplayList .='
            <div class="col-lg-3 ' . $alignment . '">
                <img class="img-responsive" alt="' . $title . '" src="imgs/printdesign/thumbs/' . $thumb . '">
            ...
            <div class="col-lg-5">
                <p><img class="img-responsive img-thumbnail" alt="' . $title . '" src="imgs/printdesign/' . $img . '"></p>
            </div>
        ';
    }
?>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container portfolio">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="centered-titles">Portfolio <span class="text-muted">Print Design</span></h1>
                </div>
