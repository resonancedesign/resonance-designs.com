<?php
    ...
    $sqlTalks = mysql_query("SELECT * FROM portfolio WHERE category='uxdesign' ORDER BY placement ASC");
    ...
    while($row = mysql_fetch_array($sqlTalks)){
        ...
        $portfolioDisplayList .='
            <div class="col-lg-3 ' . $alignment . '">
                <img class="img-responsive" alt="' . $title . '" src="imgs/uxdesign/thumbs/' . $thumb . '">
            ...
            <div class="col-lg-5">
                <p><img class="img-responsive img-thumbnail" alt="' . $title . '" src="imgs/uxdesign/' . $img . '"></p>
            </div>
        ';
    }
?>
